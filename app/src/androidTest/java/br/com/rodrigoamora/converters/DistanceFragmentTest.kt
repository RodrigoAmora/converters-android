...
class DistanceFragmentTest {
    ...
    fun testKilometerToMile() {
        ...
        Espresso
            .onView(ViewMatchers.withId(R.id.nav_distance))
            .perform(ViewActions.click())

        Espresso
            .onView(ViewMatchers.withId(R.id.input_distance))
            .perform(ViewActions.click())
            .perform(ViewActions.typeText("77"))
        ...
        Espresso
            ...
            .check(ViewAssertions.matches(ViewMatchers.withText("47.85 mi")))
            .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
    }
    ...
    fun testMileToKilometer() {
        ...
        Espresso
            ...
            .inAdapterView(ViewMatchers.withId(R.id.spinner_convert))
            .atPosition(1)
            .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
        ...
        Espresso
            .onView(ViewMatchers.withId(R.id.tv_result))
            .check(ViewAssertions.matches(ViewMatchers.withText("123.92 km")))
            .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
    }
}